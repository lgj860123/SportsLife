...
import static com.pybeta.daymatter.sportslife.application.SportsLifeApplication.APP_FOLDER_NAME;
import static com.pybeta.daymatter.sportslife.application.SportsLifeApplication.mSDCardPath;
...
//                    startNative_Baidu(activity, startLL, endLL, start_place, destination);
    ...
    public static void startNative_Baidu(Activity activity, LatLng pt1, LatLng pt2, String start_address, String end_address) {
        try {
            ...
            Log.i(TAG, "---------------" + start_address + "," + end_address);
            activity.startActivity(intent);
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public static void startGaodeNavi(Activity activity, LatLng pt1, LatLng pt2, String start_place) {
        try {
            ...
            Log.i(TAG, "poiAddress---------gaode-----------" + poiAddress);
