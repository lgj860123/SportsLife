...
public class CodeUnlockActivity extends BaseActivity {
    private static final String TAG = "CodeUnlockActivity";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Log.i(TAG, "CodeUnlockActivity------------onCreate------------------");
...
//        ShowKeyboard(editText1);
    ...
    private View.OnKeyListener keyListener = new View.OnKeyListener() {
        ...
        public boolean onKey(View v, int keyCode, KeyEvent event) {
            ...
            if ((((EditText) v).getText().toString() == null || ((EditText) v)
                ...
                Log.i(TAG, "currentEditIndex-----------" + currentEditIndex);
                if (currentEditIndex == 6)
                    currentEditIndex = 5;
                if (currentEditIndex > 0) {
                    EditText editText = getEditTextFromIndex(currentEditIndex);
                    Log.i(TAG, "editText.getTag()-----------" + editText.getTag());
    ...
    public void onPause() {
        super.onPause();
        Log.i(TAG, "CodeUnlockActivity------------onPause------------------");
    }

    public void onStop() {
        super.onStop();
        Log.i(TAG, "CodeUnlockActivity------------onStop------------------");
    }

    public void onDestroy() {
        super.onDestroy();
        unlockSuccess = false;
        Log.i(TAG, "CodeUnlockActivity------------onDestroy------------------");
    }
