...
public class LeftDrawerLayout extends ViewGroup {
    ...
    public LeftDrawerLayout(Context context, AttributeSet attrs) {
        ...
        mHelper = ViewDragHelper.create(this, 1.0f, new ViewDragHelper.Callback() {
            ...
            @Override
            public void onViewReleased(View releasedChild, float x_vel, float y_vel) {
                final int childWidth = releasedChild.getWidth();
                float offset = (childWidth + releasedChild.getLeft()) * 1.0f / childWidth;
                mHelper.settleCapturedViewAt(x_vel > 0 || x_vel == 0 && offset > 0.5f ? 0 : -childWidth, releasedChild.getTop());
                invalidate();
            }
