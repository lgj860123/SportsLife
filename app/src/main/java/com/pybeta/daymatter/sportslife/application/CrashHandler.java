...
public class CrashHandler implements Thread.UncaughtExceptionHandler{
    ...
    private static final String FILE_NAME = "sports_life_crash";
    private static final String FILE_NAME_SUF_EIX = ".txt";
    ...
    private void writeToSDCard(Throwable ex) throws IOException, PackageManager.NameNotFoundException {
        ...
        File exFile = new File(PATH +File.separator+FILE_NAME+time + FILE_NAME_SUF_EIX);
